...
#     --output_dir ./output_dir > log3.log 2>&1 &


accelerate launch /home/wangran108/question-answering/run_clm_no_trainer.py \
    --model_name_or_path /home/wangran108/baichuan\
    --train_file /home/wangran108/code/machine_quality_check/sample7.json\
    --preprocessing_num_workers 12\
    --num_train_epochs 3\
    --with_tracking \
    ...
    --max_lenghth 800 \
    --output_dir ./output_dir_baichuan > log.log 2>&1 &
